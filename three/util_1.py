...
def AES_ECB_encrypt(message, key):
    ...
    return aes_obj.encrypt(message)

def AES_ECB_decrypt(cipher, key):
    aes_obj = AES.new(key, AES.MODE_ECB)
    return aes_obj.decrypt(cipher)

def check_ECB(ciphers, blocksize = 16):
    repeated_blocks = []
    for each in ciphers:
...
def main():
    if sys.argv[1] == "1":
        ...
        assert (max(check_ECB(lines))[1]).encode('hex') == ""
